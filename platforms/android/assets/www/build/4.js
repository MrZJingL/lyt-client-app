...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"F:\ionic4\lyt\src\pages\login\login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title class="title-text">登录</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <ion-list class="top">\n\n    <ion-item>\n      <ion-label>用户名</ion-label>\n      <ion-input type="text"></ion-input>\n    </ion-item>\n  \n    <ion-item>\n      <ion-label>密码</ion-label>\n      <ion-input type="password"></ion-input>\n    </ion-item>\n    <ion-item class="login-pwd">\n      <a class="font-l">忘记密码</a>\n    </ion-item>  \n  </ion-list>\n\n\n\n\n  <button  ion-button style="width: 100%">登录</button>\n\n  <button  ion-button color="light" style="width: 100%">注册</button>\n\n</ion-content>\n'/*ion-inline-end:"F:\ionic4\lyt\src\pages\login\login.html"*/,
        }),
